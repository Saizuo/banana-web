...
$(function () {
	...
	var $factionsExplorer = $(".explorer-window.factions-explorer");

	var $faction1 = $(".faction1");
	var $faction1Explorer = $(".explorer-window.faction-1-explorer");

	var $faction2 = $(".faction2");
	var $faction2Explorer = $(".explorer-window.faction-2-explorer");

	var $faction3 = $(".faction3");
	var $faction3Explorer = $(".explorer-window.faction-3-explorer");

	var $faction4 = $(".faction4");
	var $faction4Explorer = $(".explorer-window.faction-4-explorer");

	var $map1 = $(".map1");
	var $map1Explorer = $(".explorer-window.faction-5-explorer");

	var $map2 = $(".map2");
	var $map2Explorer = $(".explorer-window.faction-6-explorer");

	var $map3 = $(".map3");
	var $map3Explorer = $(".explorer-window.faction-7-explorer");
	...
	$factions.on("click", function () {
		bindExplorer($factionsExplorer);
	})

	$faction1.on("click", function () {
		bindExplorer($faction1Explorer);
	})

	$faction2.on("click", function () {
		bindExplorer($faction2Explorer);
	})

	$faction3.on("click", function () {
		bindExplorer($faction3Explorer);
	})

	$faction4.on("click", function () {
		bindExplorer($faction4Explorer);
	})

	$map1.on("click", function () {
		bindExplorer($map1Explorer);
	})

	$map2.on("click", function () {
		bindExplorer($map2Explorer);
	})

	$map3.on("click", function () {
		bindExplorer($map3Explorer);
	})
...
for(let i = 0; i < track_list.length; i++) {
	track_classes.push(new Audio(track_list[i].path))
}
...
nextBtn.addEventListener('click', () => {
	...
	if(track_index < track_list.length - 1) {
		track_index++;
		track_classes[track_index - 1].pause();
		track_classes[track_index].play();
		document.getElementById('song-name').innerHTML = track_list[track_index].name;
		document.getElementById('song-artist').innerHTML = track_list[track_index].artist;
	}
})
...
playBtn.addEventListener('click', () => {
	 ...
	 let im = document.getElementById('info-music');
   if(!isPlaying) {
		 console.log('play')
		 ...
		 isPlaying = false;
		 track_classes[track_index].pause();
	 } 
});
...
// 		this.infoBar = document.getElementById('info-music');
// 	}
...
// 		name.innerHTML = track_list[track_index].name;
// 	}
...
// newMusicplayer.loadTrack(0);

// nextBtn.addEventListener('click', newMusicplayer.nextTrack());
// prevBtn.addEventListener('click', newMusicplayer.prevTrack());